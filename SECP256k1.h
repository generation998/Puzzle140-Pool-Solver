...
public:
  ...
  bool GetTaprootOutputKey(Point &pubKey, unsigned char *out32);
  void GetP2WSH(Point &pubKey, unsigned char *out32);
  std::string GetAddressP2TR(unsigned char *program32);
  std::string GetAddressP2WSH(unsigned char *program32);
